...
public class FloatWindowManager {
	...
	private static LayoutParams smallWindowParams;// 悬浮窗View的参数
	private static LayoutParams bigWindowParams;// 功能悬浮窗View的参数
	...
	public static void createFloatWindow(Context context) {
		...
		if (floatWindow == null) {
			...
			floatWindow.setParams(smallWindowParams);
	...
	public static void createFunctionWindow(Context context) {
		...
		if (functionWindow == null) {
			...
			if (bigWindowParams == null) {
				...
				bigWindowParams.width = FunctionWindowView.viewWidth;
				bigWindowParams.height = FunctionWindowView.viewHeight;
			}
			windowManager.addView(functionWindow, bigWindowParams);
		}
	}
